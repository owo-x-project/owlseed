...
| [lifecycle.md](lifecycle.md) | The seven stages, their invariants, and how dialogue and autonomy unify |
| [contracts.md](contracts.md) | The four core contracts, derived and external skills, precedence |
...
| [versioning.md](versioning.md) | Versions, migration, and why renaming is rare |
...
The text an agent actually obeys lives in `skills/owlseed/` -- `SKILL.md` and
`references/` -- and that is the source of truth. Where a document below overlaps the
