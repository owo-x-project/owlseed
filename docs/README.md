...
| [contracts.md](contracts.md) | The three core contracts, derived and outside skills, precedence |
...
**Work in progress is not here.** Anything still moving lives in the skill. Where a
document here and the skill have drifted apart, the skill is right and the document is
behind.
